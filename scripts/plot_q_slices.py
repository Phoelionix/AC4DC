...
pl.ax_steps.set_ylim([1e-9, 10])
pl.ax_steps.set_xlim([1,13000]) 
...
# order = [0,2,4,1,3,5]
pl.ax_steps.legend([handles[idx] for idx in order],[labels[idx] for idx in order], loc='lower left',ncol=2)

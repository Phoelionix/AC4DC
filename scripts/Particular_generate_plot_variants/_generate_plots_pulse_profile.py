...
def make_some_plots(mol_name,sim_output_parent_dir, label,figure_output_dir, tot_charge=False,bound_ionisation=False,free=False,free_slices=False,bound_ionisation_bar=False,orbital_densities_bar=False,photo_rates = False,split_free=False,combined_split_free=False):
    ...
    load_specific_atoms = ["C","N","O","S","Gd_fast"]# ["C","Fe_singleShell"]#["C","N","O","S","Gd_fast","Cl","Na"]#["Gd_fast"] #["C"]#["Fe_singleShell","C"] #None #["C","N","O"]
    ...
    if tot_charge: 
        ...
        #         ] 
        #square
        #pl.plot_tot_charge(ylim=[0,3],xlim=[-15.05,0.05],plot_legend=False,every=1,charge_difference=True,profile_height_factor=1,force_xlim=True)  #TODO automatically set to charge_difference to True if starting with ions...
        
        # gaussian
        pl.plot_tot_charge(ylim=[0,3],xlim=[None,None],plot_legend=False,every=1,charge_difference=True,profile_height_factor=1)  #TODO automatically set to charge_difference to True if starting with ions...

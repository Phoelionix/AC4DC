...
#             zeroline = False,
#             tickformat = ".1f",
#             tick0 = None, # sets automatically
#             dtick = None, # sets automatically
...
# # python3.9 scripts/snapshot.py lys_solvated_light_4 lys_solvated_6 lys_Gd_solvated_fast_1 lys_Gd_salt_solvated_fast_27 -10 0
...
handle =  "Carbon_FF"#"Carbon_294"#"Carbon_Wiggleless_2500_Fluence"#"Carbon_Sanders"""
#######
...
pl.initialise_coherence_params(-10,-7.5,q_max,photon_energy,50,100,True)
...
#pl.plot_form_factor(np.linspace(-10,0,11)) 

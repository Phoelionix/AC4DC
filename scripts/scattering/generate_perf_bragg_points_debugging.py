...
def main(par_idx):
    ...
    if target in TARGET_HANDLE_DICT:
        ...
        pdb_path = "/home/speno/AC4DC/scripts/scattering/targets/4et81atomtesting.pdb" 
        #pdb_path = "/home/speno/AC4DC/scripts/scattering/targets/4et8.pdb" 
        CNO_to_N = False; S_to_N = False
        folder = ""
        allowed_atoms = ["C","N","O","S","H", "Na", "Cl"]
    else:
    ...
    if laser_firing_qwargs["SPI"]:
        ...
        if exp_name2 != None:
            ...
            fcalc = phenix_fcalc_from_file(pdb_path,mtz_file,real=True)

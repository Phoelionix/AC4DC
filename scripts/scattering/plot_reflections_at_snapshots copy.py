...
def generate_reflections(num_time_points,start_time,end_time): 
    ...
    crystal_qwargs = dict(
        ...
        num_supercells = 1000000,#100, # 35409
...
if __name__ == "__main__":
    generate_reflections(num_time_points=100,start_time=-5,end_time=0)
...
def plot_biggest_spots_over_time(Intensities, ideal_intensities, miller_indices,times,xlim=[0,ylim=[None,None],sqrt=False,normalize=False,num_points=4,save_path = None,title="",true_normed=False):
    plt.close()
    Intensities = copy.deepcopy(Intensities)

...
refmac xyzin $refinement_model xyzout $refinement_model_tmp hklin $mtz_file hklout refmac_out.mtz  << eof-refmac 
NCYCLES 10
WEIGHT AUTO
MAKE HYDR NO
REFI BREF ISOT

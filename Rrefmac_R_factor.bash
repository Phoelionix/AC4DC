...
# model_handle=4et8
# pattern_handle=4et8_fmodel # ideal_016


# model_handle=4et8
# pattern_handle=FWDideal_group_1
...
refmac5 xyzin $model xyzout $refinement_model_tmp hklin $pattern hklout refmac_out.mtz  << eof-refmac 
NCYCLES 0
WEIGHT AUTO
MAKE HYDR NO
REFI BREF ISOT

...
rm -rf $out_path 
printf "0" | "$gmx/trjconv"  -f $xtc_file -s $struct_file -pbc nojump -skip $sample_interval  -o  $out_path -t0 $start_t_ps # printf "0" selects group 0 (the whole system) to output.
